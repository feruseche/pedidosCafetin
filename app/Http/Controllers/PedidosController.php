...
class PedidosController extends Controller
{
     public function index()
    {
      ...
      $pedidos=DB::table('ticket as t')
              ->join('clientes','clientes.id_cliente','=','t.id_cliente')
  ...
  public function corte(){
    ...
    $detalle = DB::table('ticket_detalle')
              ->select(DB::raw('sum(precio*cantidad) as monto, id_ticket'))
              ->groupBy('id_ticket')
              ->get();

    return view('pedidos.corte',["cortecaja"=>$cortecaja,"resumen"=>$resumen]);
